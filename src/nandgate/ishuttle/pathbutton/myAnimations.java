package nandgate.ishuttle.pathbutton;

import java.util.ArrayList;
import java.util.List;

import nandgate.ishuttle.nineoldandroids.animation.Animator;
import nandgate.ishuttle.nineoldandroids.animation.Animator.AnimatorListener;
import nandgate.ishuttle.nineoldandroids.view.ViewPropertyAnimator;
...
import static nandgate.ishuttle.nineoldandroids.view.ViewPropertyAnimator.animate;
...
public class myAnimations {
	 ...
	 *            �������o��layout
	 * @param poscode
	 *            λ�ô�̖���քe����RIGHTBOTTOM��CENTERBOTTOM��LEFTBOTTOM��LEFTCENTER��
