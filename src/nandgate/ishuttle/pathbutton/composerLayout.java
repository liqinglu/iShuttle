...
import nandgate.ishuttle.navigator.*;
...
public class composerLayout extends RelativeLayout {
	...
	private static OnClickListener myListener;

	/**
	 * ���캯�� ������՘��캯�����xȡ������������Ҫ��values����むattr��ͬ��layout��xml��Ҫ��������g��������
	 * ����Ԓ~�ö��˿�����֪�c�ã����҅���̫�ࣨ����N���Ӱ��o��̎����������^�_�¡�
	 * ���Զ��Ǭ��むinit()��������java��a�{�ã����xxml���� ���Ԙ��캯��ֻӛ䛂�context����
	 */
	public composerLayout(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		this.mycontext = context;
		myListener=MainActivity.mInstance;
	}
	...
	public void init(int[] imgResId, int showhideButtonId, int crossId,
		...
		for (int i = 0; i < imgResId.length; i++) {
			...
			llayouts[i].setId(56789+i);// �S���O��id������onclick���r���R�e���������؂�idֵ�S�����O�������l�Fͬ����ؼ��_ͻ�����и�һ�¡�
